...
//        'NORMATIVE_DOCS_TYPES' => NormativeDocsTypes::class,
     ...
     */
    'files_filter' => [
        "#^.+/(extracted|gar_xml)/78/AS_.+$#", // разрешает все данные для региона 78
        "#^.+/(extracted|gar_xml)/21/AS_.+$#", // разрешает все данные для региона 21
        "#^.+/(extracted|gar_xml)/AS_.+$#",    // разрешает общие словари
    ],
];
